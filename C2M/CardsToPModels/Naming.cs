...
namespace CardsToPModels
{
    public partial class NewDesign : Form
    {
        ...
        {
            this.Hide();
            DesignForm form = new DesignForm(Design.Decks.IoT);
            form.ShowDialog();
            this.Close();
        }
        ...
        {
            this.Hide();
            DesignForm form = new DesignForm(Design.Decks.Mobile);
            form.ShowDialog();
            this.Close();
        }
        ...
        {
            this.Hide();
            DesignForm form = new DesignForm(Design.Decks.Conceptual);
            form.ShowDialog();
            this.Close();
        }
    }
